...
function switchPuzzle(e) {
	var check = window.confirm('If you continue, you will lose your current progress!');
	console.log(check);
	if (check === true) {
...
function setupPuzzle() {
	// Create something to match all of the data cells in the puzzle
...
function findErrors() {
	var blocks = document.querySelectorAll('table#hitoriGrid td.blocks');
	// console.log(blocks); // Sees what these classes are returning
	var circles = document.querySelectorAll('table#hitoriGrid td.circles');
	for (var i = 0; i < blocks.length; i++) {
		if (blocks[i].style.backgroundColor === 'rgb(101, 101, 101)' || blocks[i].className === 'circles') {
	...
	// Circles
	for (var i = 0; i < blocks.length; i++) {
		if (circles[i].style.backgroundColor === 'black' || circles[i].className === 'block') {
			circles[i].style.color = 'red';
		}
	}
	setTimeout(function() {
		for (var i = 0; i < blocks.length; i++) {
			if (circles[i].style.backgroundColor === 'black' || circles[i].className === 'blocks') {
